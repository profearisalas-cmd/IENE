...
function showTab(groupName, tabId) {
    ...
    // Activar el botón presionado (buscándolo por su onclick para simplificar)
...
function toggleAccordion(element) {
    // Si queremos que solo uno esté abierto a la vez, podríamos cerrar los demás.
    // En este caso permitimos que se abran/cierren de forma independiente.
